      ...
      >
        ...
        <template v-slot:body="props">
          <q-tr :props="props" @click="onRowClick(props.row)">
            ...
            <q-td key="groups" :props="props"> [{{ props.row.groups }}] </q-td>
        ...
        <q-item>
          <q-item-section>
            <q-item
              clickable
              v-ripple
              :to="user.member_id ? '/members/' + user.member_id : null"
              class="no-padding"
            >
              <q-item-section>
            ...
            <q-item-label>
              <div class="q-gutter-x-md">
                <q-toggle
                  ...
                  color="green"
                  label="Tamu"
                  @click="toggleClick(user.id, 'guest', isGuest)"
                  disable
                />
                <q-toggle
                  v-model="isMember"
                ...
                <q-toggle
                  ...
                  color="green"
                  label="Admin"
                  @click="toggleClick(user.id, 'admin', isAdmin)"
                />
                <q-toggle
