  ...
  <div class="q-pa-xs">
    <form @submit.prevent="reset">
      <div class="q-gutter-y-md column">
        <q-input bg-color="white" outlined v-model="token" required label="Token" placeholder="Masukkan token!"
        ...
        <q-btn type="submit" class="full-width q-pa-sm" color="primary" label="Ganti Password" />
        <q-separator dark />
