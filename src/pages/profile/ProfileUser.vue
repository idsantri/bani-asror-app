    ...
    <q-card-section>
      <q-list separator>
        ...
        <q-item>
          ...
          <!-- username -->
          <q-item-section side>
            <q-icon name="edit" color="green-10" flat class="q-pr-none">
              <q-popup-edit v-model="user.username" buttons v-slot="scope">
                <q-input
                  v-model="scope.value"
                  dense
                  autofocus
        ...
        <q-item>
          ...
          <q-item-section side>
            <q-icon name="edit" color="green-10" flat class="q-pr-none">
              <q-popup-edit v-model.number="user.phone" v-slot="scope">
                <q-input
                  type="number"
