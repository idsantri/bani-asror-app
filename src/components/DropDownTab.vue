...
const report = async () => {
  $q.dialog({
    title: 'Lapor!',
    message: 'Untuk perbaikan dan/atau penambahan data baru silakan hubungi Admin!',
    cancel: true,
    persistent: true
  }).onOk(() => {
    router.push('/about')
  ...
  // await notifyAlert("Untuk perbaikan dan/atau penambahan data baru silakan hubungi Admin!<br/><br/><router-link to:'/about'>aa</router-link>", 0);
}
const print = () => {
